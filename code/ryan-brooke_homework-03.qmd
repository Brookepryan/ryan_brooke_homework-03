...
suppressMessages({ # suppress warnings and messages
  suppressWarnings({
...
ggplot(model4_preds, aes(x = x, y = predicted, color = x)) + # plotting predictions
  ...
  theme_classic() + 
  labs(title = "Predicted Impact of Water Treatment on Plant Biomass Across Different Species", # adding and changing titles
       x = "Water Treatment",
       y = "Biomass") + 
