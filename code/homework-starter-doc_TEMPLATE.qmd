...
**shoot mass and total mass have a strong positive correlation pearson r 0.902**  

**shoot mass is positively correlated with root mass pearson's r = 0.553**  

**leaf dry mass and specific leave area are not correlated, pearson r = 0.033**
...
** plants iwth larger biomass seem to have larger ranges than plants with lower biomass. Grindelia has highest biomass, acmispon has lowest**
...
**the total biomass is less with drougth stresse dtreatments and more with well watered treatments**
...
**sla doesnt eem to affect total mass visualy, but statistically it does. **
...
1. **total mass predicted by SLA, water treatment,a nd species**  
...
Out of the four models we have tried, the best model is the one that includes **model with the lowest AIC, model 1. it has all three predictors an's wriitng: all three predictors**  
...
**reference for species_name:** **species_nameAcmispon_glaber**  

Interpret the model estimates for the:  

- intercept: **mass of Acmispon Glaber in droght stressed treatment when SLA = 0**  
- SLA slope: **accross drought treatment and spcies, with each 1 unit increase in SLA(mm^2/dry mass of leaf), we expect an increase in total mas of -0.00025 WHICH MEANS WITH THE ESTIMATE AND STANDARD ERROR THERE IS NO EEFCET OF SL ON TOTAL MASS**  
- well watered estimate: **across species and SLA, well watered plants tend to be 0.12 +/- (figure out how to write plus minus) 0.02 grams heaver than drought stress plants**    
